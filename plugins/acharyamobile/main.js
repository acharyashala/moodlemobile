var templates = [
    "root/externallib/text!root/plugins/acharyamobile/theme.css",
    "root/externallib/text!root/plugins/acharyamobile/login.html",
    "root/externallib/text!root/plugins/acharyamobile/program.html"
];
...
define(templates, function (theme, loginForm, program) {
    var plugin = {
        ...
        routes: [
            ["acharyamobile", "show_program", "showProgram"]
        ],

        showProgram: function() {
            var tpl = {};
            var html = MM.tpl.render(program, tpl);
            MM.panels.show('center', html, {title: MM.lang.s("acharyamobile")});
        }
    };
